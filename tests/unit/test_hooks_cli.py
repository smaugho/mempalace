...
# v3.5.0 (2026-05-14): the finalize-phase lockdown gate is retired
# along with the pending_feedback limbo state. tool_extend_feedback +
# the agent-rated memory_feedback / operation_ratings coverage cycle
# are gone; mempalace.feedback_auto's Haiku rater fills ratings out
# of band after finalize. The Piece D test family that pinned the
