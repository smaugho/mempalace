...
def tool_kg_search(  # noqa: C901
    ...
    try:
        ...
        # returns the top-level similar_contexts list with link_score.
        from .scoring import render_similar_contexts_block as _render_sc

        _similar_contexts_block = _render_sc(
            projected,
