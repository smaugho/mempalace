...
_SYSTEM_PROMPT = (
    ...
    "while the content is specific and informative. (You may also "
    "propose a better summary per-item as described above — prefer "
    "proposing a rewrite over flagging when you can.)\n"
