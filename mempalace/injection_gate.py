...
def run_state_judge(
    *,
    ...
    system_prompt = (
        ...
        "the agent absorbs one state_deltas ack per flag. There is "
        "real cost to under-flagging -- stale state silently "
        "accumulates in the graph and downstream queries return "
        "wrong answers. Default to flag.\n\n"
