...
# v3.9.0 (Adrian directive 2026-05-19): tool_recall_dialogue removed.
# Replaced by tool_kg_search(include_user_messages=True) -- single tool
# surface, reuses the existing search infrastructure. See tool_read.py
# and the v3.9.0 commit for the rationale (minimum-tool architecture;
# user_message side-channel SQL LIKE scan lives inside kg_search now).
